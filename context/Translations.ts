...
export const translations = {
  id: {
    ...
    receipt: {
      ...
      accessibility:  "Aksesibilitas",
      halalNote:      "Semua menu kami hanya dibuat dari bahan baku yang mengikuti prosedur pengolahan yang halal, berkualitas, dan ramah lingkungan.",
      // ── Tambahan: label & kalimat di isi struk yang sebelumnya hardcode ──
      receiptNo:          "Nota",
      dateLabel:          "Tanggal",
      cashierLabel:       "Kasir",
      ...
      paidLabel:          "LUNAS",
      showCodeToCashier:  "Tunjukkan kode ini ke kasir",
      cashierWillProcess: "Kasir akan memproses pembayaranmu",
      greeting:           "Halo",
      pointsAdded:        "poin ditambahkan",
      checkPointsApp:     "Cek poin di aplikasi Kopi Jaya",
      thankYou:           "Terima Kasih",
      forYourVisit:       "Atas Kunjungan Anda",
      cashPaymentLabel:   "Tunai",
      receiptTitleWord:   "Struk",
    },
  ...
  en: {
    ...
    receipt: {
      ...
      accessibility: "Accessibility",
      halalNote:     "All our menus are only made from ingredients that follow halal processing procedures, are high-quality, and eco-friendly.",
      // ── Added: labels & sentences in the receipt body that were previously hardcoded ──
      ...
      paidLabel:          "PAID",
      showCodeToCashier:  "Show this code to the cashier",
      cashierWillProcess: "The cashier will process your payment",
      greeting:           "Hello",
      pointsAdded:        "points added",
      checkPointsApp:     "Check your points in the Kopi Jaya app",
      thankYou:           "Thank You",
      forYourVisit:       "For Your Visit",
      cashPaymentLabel:   "Cash",
      receiptTitleWord:   "Receipt",
    },
